...
SELECT DI.id, DI.contacto_id, COM.nombre, DI.nombre, DI.descripcion, DI.tipo, DI.anos_uso, DI.estado FROM dispositivo DI, contacto CO, comuna COM WHERE DI.contacto_id=CO.id AND CO.comuna_id=COM.id ORDER BY id DESC LIMIT 5, 5
